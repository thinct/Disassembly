...
; *intptr_0x00726E88 = 0x123
/*0x004011CB*/    push 0x4
/*0x004011CD*/    call new
/*0x004011D2*/    mov esi, eax
/*0x004011D6*/    mov dword ptr ds:[esi], 0x123
;[esi]=[0x00726E88]=0xBAADF00D
;[esi]=[0x00726E88]=0x00000123  <-- Modify

; intptr_var_0x00728A1C = intptr_0x00726E88
/*0x004011D4*/    push 0x8
/*0x004011DC*/    call new
/*0x004011E1*/    mov edi, eax
/*0x004011EF*/    mov dword ptr ds:[edi], 0x888
;[edi]=[0x00728A18]=0xBAADF00D
;[edi]=[0x00728A18]=0x00000888  <-- Modify
/*0x004011EC*/    mov dword ptr ds:[edi+0x4], esi
;[edi+0x4]=[0x00728A1C]=0xBAADF00D
;[edi+0x4]=[0x00728A1C]=0x00726E88  <-- Modify

/*0x004011EA*/    push 0x4
/*0x004011F5*/    call new
/*0x004011FA*/    mov ebx, eax
/*0x00401218*/    mov dword ptr ds:[ebx], 0x987
;[ebx]=[0x00725520]=0xBAADF00D
;[ebx]=[0x00725520]=0x00000987  <-- Modify
/*0x00401206*/    mov dword ptr ss:[ebp-0x20], ebx
;[ebp-0x20]=[0x0019FF08]=0x004030FC
;[ebp-0x20]=[0x0019FF08]=0x00725520  <-- Modify

/*0x0040120E*/    add esp, 0xC ; 前面三个new的push在这里一次性平栈
...
;[eax]=[0x00728A18]=0x00000888
/*0x00401408*/    mov eax, dword ptr ds:[eax+0x4]
;[eax+0x4]=[0x00728A1C]=0x00726E88
/*0x0040140B*/    mov dword ptr ds:[edx], ecx
;[edx]=[0x00728A70]=0xBAADF00D
;[edx]=[0x00728A70]=0x00000888  <-- Modify
...
;[ebp-0x18]=[0x0019FF10]=0x00728A78
...
;[ebp-0x18]=[0x0019FF10]=0x00728AA0
/*0x00401264*/    mov edi, dword ptr ss:[ebp-0x1C]
;[ebp-0x1C]=[0x0019FF0C]=0x00728A90
...
;/*0x00401270*/    je 0x0040128D
	...
	;[edi+ebx*8+0x4]=[0x00728A94]=0x00726E88
	/*0x00401276*/    push dword ptr ds:[eax]
	;[eax]=[0x00726E88]=0x00000123
	/*0x00401278*/    push dword ptr ds:[edi+ebx*8]
	;[edi+ebx*8]=[0x00728A90]=0x00000888
	/*0x0040127B*/    push 0x403198
	/*0x00401280*/    call printf
	/*0x00401285*/    inc ebx
...
;[ebp-0x10]=[0x0019FF18]=0xCDFC1F44
